...
if (customizeSite == "true") { // Site branding is customized
    ...
    // Add a favicon
    document.write('<link rel="icon" type="icon/x-image" href="https://visualvm.dev.java.net/favicon.ico">');
    document.write('<link rel="shortcut icon" type="icon/x-image" href="https://visualvm.dev.java.net/favicon.ico">');
